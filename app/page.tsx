...
export default function Home() {
	return (
		<main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-100 to-purple-200 p-6">
			<div className="max-w-2xl w-full bg-white/80 rounded-xl shadow-lg p-8 text-center">
				<Image
					src="/vercel.svg"
					alt="Profile"
					width={96}
					height={96}
					className="mx-auto mb-6 rounded-full border-4 border-blue-300 shadow"
				/>
				<h1 className="text-4xl font-bold mb-2 text-gray-800">Aditya Patel</h1>
				<h2 className="text-xl text-blue-600 mb-4">Web Developer & Designer</h2>
				...
				<div className="flex justify-center gap-4 mb-6">
					...
					<a
						href="#projects"
						className="px-4 py-2 bg-gray-200 text-blue-700 rounded hover:bg-blue-300 transition"
					>
						View Projects
					</a>
				</div>
